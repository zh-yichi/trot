"""
Example: unrestricted LNO-AFQMC/pt2CCSD with trot.lnotrot
=========================================================
...
Run from the repository root:  python trot/lnotrot/examples/lnotrot_upt2ccsd.py
"""
...
mol = gto.M(atom="O 0 0 0; O 0 0 1.20577", basis="sto-6g", spin=2, verbose=4)
...
mycc.kernel()
af = AfqmcMixed(mycc, trial="upt2ccsd_bar", norb_frozen_core=nfrozen, n_walkers=300, n_eql_blocks=80, n_blocks=300, seed=27)
